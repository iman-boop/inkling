...
**Read `project/Handwriting Font App.dc.html` in full.** The user had this file open when they triggered the handoff, so it's almost certainly the primary design they want built. Read it top to bottom — don't skim. Then **follow its imports**: open every file it pulls in (shared components, CSS, scripts) so you understand how the pieces fit together before you start implementing.
...
- `project/` — the `Handwritten Notes to Font App` project files (HTML prototypes, assets, components)
